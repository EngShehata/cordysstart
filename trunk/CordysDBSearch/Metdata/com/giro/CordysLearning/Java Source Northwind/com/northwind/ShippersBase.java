...
public abstract class ShippersBase extends com.cordys.cpc.bsf.busobject.StateBusObject
{
    ...
    public static BusObjectIterator<com.northwind.Shippers> getNextShippersObjects(int ShipperID, com.cordys.cpc.bsf.query.Cursor cursor)
    {
    ...
    public static BusObjectIterator<com.northwind.Shippers> getPreviousShippersObjects(int ShipperID, com.cordys.cpc.bsf.query.Cursor cursor)
    {
    ...
    public static com.northwind.Shippers getShippersObject(int ShipperID)
    {
    ...
    public static BusObjectIterator<com.northwind.Shippers> getShippersObjects(int fromShipperID, int toShipperID, com.cordys.cpc.bsf.query.Cursor cursor)
    {
    ...
    public static BusObjectIterator<com.northwind.Shippers> getShippersObjects(int fromShipperID, int toShipperID)
    {
        String queryText = "select * from \"Shippers\" where \"ShipperID\" between :fromShipperID and :toShipperID";
        QueryObject query = new QueryObject(queryText);
        query.addParameter("fromShipperID", "Shippers.ShipperID", QueryObject.PARAM_INT, new Integer(fromShipperID));
