...
public abstract class CategoriesBase extends com.cordys.cpc.bsf.busobject.StateBusObject
{
    ...
    public static com.northwind.Categories getCategoriesObject(int CategoryID)
    {
    ...
    public static BusObjectIterator<com.northwind.Categories> getCategoriesObjects(int fromCategoryID, int toCategoryID, com.cordys.cpc.bsf.query.Cursor cursor)
    {
    ...
    public static BusObjectIterator<com.northwind.Categories> getCategoriesObjects(int fromCategoryID, int toCategoryID)
    {
        String queryText = "select * from \"Categories\" where \"CategoryID\" between :fromCategoryID and :toCategoryID";
        QueryObject query = new QueryObject(queryText);
        query.addParameter("fromCategoryID", "Categories.CategoryID", QueryObject.PARAM_INT, new Integer(fromCategoryID));
    ...
    public static BusObjectIterator<com.northwind.Categories> getNextCategoriesObjects(int CategoryID, com.cordys.cpc.bsf.query.Cursor cursor)
    {
    ...
    public static BusObjectIterator<com.northwind.Categories> getPreviousCategoriesObjects(int CategoryID, com.cordys.cpc.bsf.query.Cursor cursor)
    {
