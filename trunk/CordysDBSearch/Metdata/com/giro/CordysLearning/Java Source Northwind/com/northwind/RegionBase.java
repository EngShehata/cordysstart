...
public abstract class RegionBase extends com.cordys.cpc.bsf.busobject.StateBusObject
{
    ...
    public static BusObjectIterator<com.northwind.Region> getNextRegionObjects(int RegionID, com.cordys.cpc.bsf.query.Cursor cursor)
    {
    ...
    public static BusObjectIterator<com.northwind.Region> getPreviousRegionObjects(int RegionID, com.cordys.cpc.bsf.query.Cursor cursor)
    {
    ...
    public static com.northwind.Region getRegionObject(int RegionID)
    {
    ...
    public static BusObjectIterator<com.northwind.Region> getRegionObjects(int fromRegionID, int toRegionID, com.cordys.cpc.bsf.query.Cursor cursor)
    {
    ...
    public static BusObjectIterator<com.northwind.Region> getRegionObjects(int fromRegionID, int toRegionID)
    {
        String queryText = "select * from \"Region\" where \"RegionID\" between :fromRegionID and :toRegionID";
        QueryObject query = new QueryObject(queryText);
        query.addParameter("fromRegionID", "Region.RegionID", QueryObject.PARAM_INT, new Integer(fromRegionID));
