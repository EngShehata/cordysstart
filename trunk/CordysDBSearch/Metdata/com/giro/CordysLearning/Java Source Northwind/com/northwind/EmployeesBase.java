...
public abstract class EmployeesBase extends com.cordys.cpc.bsf.busobject.StateBusObject
{
    ...
    public static com.northwind.Employees getEmployeesObject(int EmployeeID)
    {
    ...
    public static BusObjectIterator<com.northwind.Employees> getEmployeesObjects(int fromEmployeeID, int toEmployeeID, com.cordys.cpc.bsf.query.Cursor cursor)
    {
    ...
    public static BusObjectIterator<com.northwind.Employees> getEmployeesObjects(int fromEmployeeID, int toEmployeeID)
    {
        String queryText = "select * from \"Employees\" where \"EmployeeID\" between :fromEmployeeID and :toEmployeeID";
        QueryObject query = new QueryObject(queryText);
        query.addParameter("fromEmployeeID", "Employees.EmployeeID", QueryObject.PARAM_INT, new Integer(fromEmployeeID));
    ...
    public static BusObjectIterator<com.northwind.Employees> getEmployeesObjectsForReportsTo(int ReportsTo)
    {
    ...
    public static BusObjectIterator<com.northwind.Employees> getNextEmployeesObjects(int EmployeeID, com.cordys.cpc.bsf.query.Cursor cursor)
    {
    ...
    public static BusObjectIterator<com.northwind.Employees> getPreviousEmployeesObjects(int EmployeeID, com.cordys.cpc.bsf.query.Cursor cursor)
    {
