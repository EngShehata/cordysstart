...
public abstract class SuppliersBase extends com.cordys.cpc.bsf.busobject.StateBusObject
{
    ...
    public static BusObjectIterator<com.northwind.Suppliers> getNextSuppliersObjects(int SupplierID, com.cordys.cpc.bsf.query.Cursor cursor)
    {
    ...
    public static BusObjectIterator<com.northwind.Suppliers> getPreviousSuppliersObjects(int SupplierID, com.cordys.cpc.bsf.query.Cursor cursor)
    {
    ...
    public static com.northwind.Suppliers getSuppliersObject(int SupplierID)
    {
    ...
    public static BusObjectIterator<com.northwind.Suppliers> getSuppliersObjects(int fromSupplierID, int toSupplierID, com.cordys.cpc.bsf.query.Cursor cursor)
    {
    ...
    public static BusObjectIterator<com.northwind.Suppliers> getSuppliersObjects(int fromSupplierID, int toSupplierID)
    {
        String queryText = "select * from \"Suppliers\" where \"SupplierID\" between :fromSupplierID and :toSupplierID";
        QueryObject query = new QueryObject(queryText);
        query.addParameter("fromSupplierID", "Suppliers.SupplierID", QueryObject.PARAM_INT, new Integer(fromSupplierID));
